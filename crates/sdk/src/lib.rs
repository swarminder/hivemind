...
pub fn package_certification_supported_schemas() -> Vec<String> {
    vec![
        ...
        router::ROUTE_PLAN_V2_SCHEMA_VERSION,
        router::ROUTE_PLAN_V2_VERIFICATION_SCHEMA_VERSION,
        router::ROUTE_FAILURE_ANALYSIS_SCHEMA_VERSION,
        router::ROUTE_FAILURE_ANALYSIS_VERIFICATION_SCHEMA_VERSION,
        router::CAPACITY_RESERVATION_SCHEMA_VERSION,
        router::CAPACITY_RESERVATION_VERIFICATION_SCHEMA_VERSION,
        router::RETRY_DECISION_SCHEMA_VERSION,
        router::RETRY_DECISION_VERIFICATION_SCHEMA_VERSION,
        ...
        weeb3_adapter::BROWSER_SWARM_STORAGE_PROVIDER_V6_SCHEMA_VERSION,
        weeb3_adapter::BROWSER_PUBLISH_ONE_RESULT_SCHEMA_VERSION,
        local_runner::LOCAL_MODEL_RUNNER_DESCRIPTOR_SCHEMA_VERSION,
        local_runner::LOCAL_MODEL_INFERENCE_OUTPUT_SCHEMA_VERSION,
        local_runner::OLLAMA_LOCAL_MODEL_CONFIG_SCHEMA_VERSION,
        ...
        marketplace::PAYMENT_AUTHORIZATION_V2_SCHEMA_VERSION,
        marketplace::PAYMENT_AUTHORIZATION_V2_VERIFICATION_SCHEMA_VERSION,
        marketplace::ESCROW_RECORD_SCHEMA_VERSION,
        marketplace::ESCROW_RECORD_VERIFICATION_SCHEMA_VERSION,
        marketplace::ESCROW_RECORD_V2_SCHEMA_VERSION,
        marketplace::ESCROW_RECORD_V2_VERIFICATION_SCHEMA_VERSION,
        marketplace::SETTLEMENT_RECORD_V2_SCHEMA_VERSION,
        marketplace::SETTLEMENT_RECORD_V2_VERIFICATION_SCHEMA_VERSION,
        marketplace::DISPUTE_RECORD_V2_SCHEMA_VERSION,
        marketplace::DISPUTE_RECORD_V2_VERIFICATION_SCHEMA_VERSION,
        ...
        marketplace::MARKETPLACE_AUDIT_EVENT_SCHEMA_VERSION,
        marketplace::MARKETPLACE_AUDIT_EVENT_VERIFICATION_SCHEMA_VERSION,
        marketplace::SLASHING_DECISION_SCHEMA_VERSION,
        marketplace::SLASHING_DECISION_VERIFICATION_SCHEMA_VERSION,
        ...
        vector::RAG_INGEST_REQUEST_SCHEMA_VERSION,
        vector::RAG_CHUNK_RECORD_SCHEMA_VERSION,
        vector::RAG_EMBEDDING_RECORD_SCHEMA_VERSION,
        vector::RAG_INDEX_SNAPSHOT_SCHEMA_VERSION,
        vector::RAG_INGEST_RESULT_SCHEMA_VERSION,
        vector::RAG_SEARCH_REQUEST_SCHEMA_VERSION,
        vector::RAG_SEARCH_RESULT_SCHEMA_VERSION,
        vector::RAG_ASK_REQUEST_SCHEMA_VERSION,
        vector::RAG_ANSWER_RECEIPT_SCHEMA_VERSION,
        vector::RAG_ANSWER_RESULT_SCHEMA_VERSION,
        workflow::TOOL_INVOCATION_SCHEMA_VERSION,
        workflow::TOOL_INVOCATION_VERIFICATION_SCHEMA_VERSION,
        workflow::TOOL_RESULT_SCHEMA_VERSION,
        workflow::TOOL_RESULT_VERIFICATION_SCHEMA_VERSION,
        workflow::AGENT_RUN_STATE_SCHEMA_VERSION,
        workflow::AGENT_RUN_STATE_VERIFICATION_SCHEMA_VERSION,
        workflow::HUMAN_APPROVAL_REQUEST_SCHEMA_VERSION,
        workflow::HUMAN_APPROVAL_REQUEST_VERIFICATION_SCHEMA_VERSION,
        workflow::MEMORY_WRITE_SCHEMA_VERSION,
        workflow::MEMORY_WRITE_VERIFICATION_SCHEMA_VERSION,
